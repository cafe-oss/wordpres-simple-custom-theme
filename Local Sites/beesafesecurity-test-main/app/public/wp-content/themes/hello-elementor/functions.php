...
if (! function_exists('custom_enqueue_styles')) :
	...
	function custom_enqueue_styles()
	{
		wp_enqueue_style(
			'custom-style',
			get_parent_theme_file_uri('main.css'),
			array(),
		...
		wp_enqueue_style(
			'custom-header-style',
			get_parent_theme_file_uri('custom-header.css'),
			array(),
			wp_get_theme()->get('Version')
		);
		...
		wp_enqueue_style(
			'custom-footer-style',
			get_parent_theme_file_uri('custom-footer.css'),
			array(),
			wp_get_theme()->get('Version')
		);
		...
		wp_enqueue_script(
			...
			array(), // Dependencies, like array('jquery')
			null,
			true // Load in footer
		);

		wp_enqueue_style('worksans-font', 'https://fonts.googleapis.com/css2?family=Work+Sans:wght@400;500;600;700&display=swap');
		wp_enqueue_style('satoshi-font', 'https://api.fontshare.com/v2/css?f[]=satoshi@400,500,700&display=swap');

		// Enqueue Swiper CSS nad JS
